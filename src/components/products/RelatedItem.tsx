            ...
            <div className="w-full h-24 md:h-[20vh] overflow-hidden relative rounded-t-md">
                ...
                <div className="absolute bottom-3 right-3">
                    <div className="flex items-center mt-3 w-full">
                        <button aria-label="Reducir cantidad de productos" onClick={handleDecreaseQuantity} className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-l">
                            <MdOutlineAddCircleOutline className="h-8 w-8"/>
                        </button>
                        <div className="bg-gray-200 text-gray-700 font-bold py-2 px-4">
                            {quantities[product.id] || 0}
                        </div>
                        <button aria-label="Aumentar cantidad de productos"  onClick={handleIncreaseQuantity} className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-r">
